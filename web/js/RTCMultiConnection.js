...
window.RTCMultiConnection = function (roomid, forceOptions) {
        ...
        function handle(connection) {
            ...
            connection.onFileEnd = function (file) {
                ...
                if (file.type.indexOf('image') != -1) {
                    var imgno = document.getElementById("room-item-info").getElementsByTagName('img').length;

                    if (imgno != 0) {
                        document.getElementById("room-item-info").getElementsByTagName('div')[1].id = "removeimg";
                        document.getElementById("removeimg").remove();
						if(roomidno != ""){
							div.innerHTML = '<img src="' + file.url + '" title="' + file.name + '"style="width:60%; height:100%">';
						}else{
							div.innerHTML = '<img src="' + file.url + '" title="' + file.name + '"style="width:80%; height:100%">';
						}
                    ...
                    div.innerHTML = '<iframe src="' + file.url + '" title="' + file.name + '" style="width: 80%;border: 0;height: inherit;margin-top:1em;"></iframe>';
                }
            };
    ...
    (function (connection) {
        ...
        connection.onCustomMessage = function (message) {
            ...
            if (message.unepectedUserJoinedRoom) {
                // tell participant(s)
                alert('Unexpected user joined room!');
            }
        };
